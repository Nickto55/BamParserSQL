...
if __name__ == "__main__":
    app = ExcelReader(r"C:\Users\yakovlev_nd\Desktop\Tests\gfgdgssd\26,06,01-08,31.xlsx", sheet_name="Изделия")
    result = app.get_dict_all_data()
    for sda, asd in result.items():
        print(sda, asd)
